...
public interface iMatches {
    ...
    /**
     * Retorna as estatísticas das partidas jogadas em casa por um time específico em um campeonato.
     *
    ...
    /**
     * Retorna as estatísticas das partidas jogadas fora de casa por um time específico em um campeonato.
     *
     * @param idcampeonato ID do campeonato.
     * @param idtime ID do time.
    ...
    /**
     * Retorna as estatísticas gerais de um time em um campeonato, incluindo total de partidas, vitórias, empates, derrotas, gols feitos, gols sofridos, saldo de gols e total de pontos.
     *
     * @param idcampeonato ID do campeonato.
     * @return Estatísticas gerais do time no campeonato.
     */
