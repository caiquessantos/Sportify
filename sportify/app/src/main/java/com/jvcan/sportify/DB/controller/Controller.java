...
/**
 * Classe de controle que encapsula a lógica de negócio para operações
 * relacionadas a partidas, estatísticas de futebol e voleibol,
...
public class Controller {
     ...
     *
     * @param context Contexto da aplicação Android para acesso aos DAOs e ao banco
     *                de dados.
     */
     ...
     */
    public long createMatch(Long idcampeonato, String local, String data, String horario, int placarTime1,
            int placarTime2) {
     ...
     */
    public Boolean updateMatch(Long idPartida, Long idcampeonato, String local, String data, String horario,
            int placarTime1, int placarTime2) {
     ...
     * @param idpartida    ID da partida.
     * @param idcampeonato ID do campeonato ao qual a partida pertence.
     * @return Objeto Partida contendo os detalhes da partida, ou null se não
     *         encontrada.
     */
     ...
     * @return Objeto PartidaCasaStats contendo as estatísticas das partidas como
     *         mandante.
     */
     ...
     * @param idcampeonato ID do campeonato.
     * @param idtime       ID do time.
     * @return Objeto PartidaForaStats contendo as estatísticas das partidas como
     *         visitante.
     */
     ...
     */
    public boolean createStatsFut(Long idPartida, Long idJogador, int gols, int assists, int cartoesAmarelos,
     ...
     * @param idpartida ID da partida.
     * @param idjogador ID do jogador.
     * @return Objeto FutStats contendo as estatísticas do jogador na partida, ou
     ...
     * @param cartoesAmarelos  Novo número de cartões amarelos recebidos pelo
     *                         jogador.
     * @param cartoesVermelhos Novo número de cartões vermelhos recebidos pelo
     *                         jogador.
     * @return True se a atualização foi bem-sucedida, false caso contrário.
     */
    public boolean updateStatsFut(Long idStats, Long idPartida, Long idJogador, int gols, int assists,
     ...
     * @param idPartida ID da partida.
     * @param idJogador ID do jogador.
     * @return True se as estatísticas foram deletadas com sucesso, false caso
     *         contrário.
     */
     ...
     *
     * @return Lista de objetos FutStats contendo todas as estatísticas de futebol
     *         registradas.
     */
    ...
    /**
     * Retorna a lista dos principais artilheiros (jogadores com mais gols marcados)
     * em um campeonato específico.
     *
     * @param idcampeonato ID do campeonato.
     * @return Lista de objetos ArtilhariaFut representando os principais
     *         artilheiros.
     */
    ...
    /**
     * Retorna a lista dos principais assistentes (jogadores com mais assistências)
     * em um campeonato específico.
     *
     * @param idcampeonato ID do campeonato.
    ...
    /**
     * Retorna a lista de cartões amarelos recebidos por jogadores em um campeonato
     * específico.
     *
     * @param idcampeonato ID do campeonato.
    ...
    /**
     * Retorna a lista de cartões vermelhos recebidos por jogadores em um campeonato
     * específico.
     *
     * @param idcampeonato ID do campeonato.
     ...
     * @param idpartida ID da partida.
     * @param idjogador ID do jogador.
     * @return Objeto VolStats contendo as estatísticas do jogador na partida, ou
     *         null se não encontrado.
     */
     ...
     *
     * @return Lista de objetos VolStats contendo todas as estatísticas de voleibol
     *         registradas.
     */
    ...
    /**
     * Retorna a lista dos principais artilheiros (jogadores com mais pontos
     * acumulados) em um campeonato específico de voleibol.
     *
     * @param idcampeonato ID do campeonato.
     * @return Lista de objetos ArtilhariaVol representando os principais
     *         artilheiros.
     */
     ...
     * @param idtime    ID do time.
     * @param idpartida ID da partida.
     * @param mandante  Boolean indicando se o time é mandante (true) ou visitante
     *                  (false).
     * @return True se o registro foi criado com sucesso, false caso contrário.
     */
     ...
     *
     * @param idpartida ID da partida.
     * @return Objeto JogaPartida contendo a participação do time na partida, ou
     *         null se não encontrado.
     */
     ...
     * @param idtime    ID do time.
     * @param idpartida ID da partida.
     * @return True se a participação foi deletada com sucesso, false caso
     *         contrário.
     */
